...
http.createServer(function(request, response) {
    ...
    sessions(request, response, function() {
        ...
        injector.bind("user").toProvider(userProvider);
        ...
        dispatcher.add(/^\/grammars\/([a-z0-9\-_]+)\/edit\/$/, "name", require("./controllers/grammar/edit"));
        dispatcher.add(/^\/edit-my-grammar\/$/, require("./controllers/grammar/edit-logged-in-users-grammar"));
