...
indexHandler = injectable("htmlContent", function(htmlContent) {
    htmlContent("index", {});
});
...
grammarSourceHandler = injectable("grammarRepository", "htmlContent", "pathParameters", function(grammars, htmlContent, pathParameters) {
    var name = pathParameters.name;
    grammars.fetchByName(name, function(error, grammar) {
        if (grammar === null) {
            return defaultHandler(htmlContent);
