var injectable = require("ZWOBBLE/abuse/web/inject").injectable,
    jsonTemplate = require("json-template"),
    fs = require('fs'),
    sys = require("sys");

exports.htmlContent = injectable("response", function(response) {
    return function(templateName, json, status) {
